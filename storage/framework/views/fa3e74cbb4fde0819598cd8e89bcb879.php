        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('admin.mapExplore')); ?>"
                        class="nav-item <?php echo e(request()->routeIs('admin.mapExplore') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('admin.corporationdata')); ?>" class="nav-item">
                        <i class="fas fa-chart-bar"></i>
                        <span class="nav-text">Corporation Data</span>
                    </a>
                    <a href="<?php echo e(route('admin.users')); ?>" class="nav-item">
                        <i class="fas fa-users"></i>
                        <span class="nav-text">Users</span>
                        <span class="nav-badge">3</span>
                    </a>
                    <a href="<?php echo e(route('admin.team.index')); ?>" class="nav-item">
                        <i class="fas fa-users"></i>
            ...
            <div class="header-right">
                ...
                <div class="user-profile" id="user-profile">
                    <div class="user-avatar">
                        <?php if(Auth::user()->profile && file_exists(public_path(Auth::user()->profile))): ?>
                        <img src="<?php echo e(asset(Auth::user()->profile)); ?>"
                            alt="User Profile"
...
<?php /**PATH D:\testinggayu\resources\views/layouts/admin-layout.blade.php ENDPATH**/ ?>