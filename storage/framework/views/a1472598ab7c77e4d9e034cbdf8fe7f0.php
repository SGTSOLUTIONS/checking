    ...
    <script>
        $(document).ready(function() {
            ...
            function loadTeamsData() {
                $.ajax({
                    url: '<?php echo e(route('admin.teams.data')); ?>',
                    type: 'GET',
                    dataType: 'json',
                    beforeSend: function() {
                        $('#teamsContainer').html(`
...
<?php echo $__env->make('layouts.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\testinggayu\resources\views/admin/teams.blade.php ENDPATH**/ ?>