<?php $__env->startSection('title', 'Ward Management'); ?>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0" id="corporationInfo">
                    <i class="fas fa-city me-1"></i><?php echo e($corporation->name ?? 'N/A'); ?> - <?php echo e($corporation->code ?? 'N/A'); ?>

                </p>
            </div>
            <div>
                <a href="<?php echo e(url('admin/corporation-data')); ?>" class="btn btn-outline-secondary me-2">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="wardForm" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="corporation_id" value="<?php echo e($corporationId); ?>">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control bg-light"
                                    value="<?php echo e($corporation->name); ?> (<?php echo e($corporation->code); ?>)" readonly>
                                <small class="form-text text-muted">Corporation ID: <?php echo e($corporationId); ?></small>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadWardData() {
                $.ajax({
                    url: `<?php echo e(url('admin/wards')); ?>/<?php echo e($corporationId); ?>/data`,
                    type: 'GET',
                    dataType: 'json',
                    beforeSend: function() {
            ...
            function renderWardCards(wards) {
                ...
                wards.forEach(ward => {
                    const droneImageUrl = ward.drone_image ?
                        `<?php echo e(asset('')); ?>${ward.drone_image}` :
                        '';
            ...
            $('#wardForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('admin.wards.store')); ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            if (ward.drone_image) {
                                ...
                                <img src="<?php echo e(asset('')); ?>${ward.drone_image}"
...
<?php echo $__env->make('layouts.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\testinggayu\resources\views/admin/wards.blade.php ENDPATH**/ ?>