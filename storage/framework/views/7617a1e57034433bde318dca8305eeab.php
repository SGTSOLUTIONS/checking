<?php $__env->startSection('title', 'Tracking Map View'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">
                Tracking: <strong id="userNameDisplay"><?php echo e($userName ?? 'Surveyor'); ?></strong>
                (Role: <span id="userRoleDisplay"><?php echo e($userRole ?? 'surveyor'); ?></span>)
            </p>
        </div>
...
let polylines = [];
let trackingData = [];
let userId = <?php echo e($userId ?? 'null'); ?>;
...
function renderMap() {
    ...
    trackingData.forEach((point, index) => {
        ...
        const marker = L.marker([parseFloat(point.latitude), parseFloat(point.longitude)], { icon: markerIcon })
            .bindPopup(`
...
$(document).ready(function() {
    ...
    if (userId) {
        ...
        $('#timeline').html('<p class="text-muted text-center">No user selected. Please go back and select a user.</p>');
    }
});
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\testinggayu\resources\views/admin/tracking/map-view.blade.php ENDPATH**/ ?>