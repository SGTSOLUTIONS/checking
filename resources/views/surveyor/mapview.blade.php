...
@section('content')
    ...
    <div class="mobile-bottom-nav">
        <button class="mobile-nav-btn" id="mobileLayerBtn"><i class="fas fa-layer-group"></i><span>Layers</span></button>
        <button class="mobile-nav-btn" id="mobileSearchBtn"><i class="fas fa-search"></i><span>Search</span></button>
        <button class="mobile-nav-btn" id="mobileLocationBtn"><i
                class="fas fa-location-dot"></i><span>Location</span></button>
        <button class="mobile-nav-btn" id="mobileRouteBtn"><i class="fas fa-route"></i><span>Route</span></button>
        <button class="mobile-nav-btn" id="mobileEditBtn"><i class="fas fa-pen-to-square"></i><span>Edit</span></button>
    </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3"><label class="form-label">Road Name</label><select class="form-select" id="road_name" name="road_name"><option value="">Select Road Name</option>@if (isset($uniqueRoadNames))@foreach ($uniqueRoadNames as $roadName)<option value="{{ $roadName }}">{{ $roadName }}</option>@endforeach @endif</select><div id="road_name_error" class="error-message text-danger small"></div></div>
            ...
            function setupBuildingImagePreview() {
