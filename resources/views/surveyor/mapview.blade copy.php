    ...
    <script>
        $(document).ready(function() {
            ...
            <div class="shop-item mb-4 p-3 border rounded position-relative" data-shop-index="${shopNumber}" style="background: #f8f9fa; transition: all 0.3s ease;">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <label for="prof_tax_assessment" class="form-label">Professional Tax Assessment</label>
                        <input type="text" name="prof_tax_assessment_${prof_tax_assessment}" class="form-control" id="prof_tax_assessment">
                        <div id="prof_tax_assessment_error_${prof_tax_assessment}" class="error-message text-danger"></div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="old_prof_tax_assessment" class="form-label">Old Professional Tax Assessment</label>
                        <input type="text" name="old_prof_tax_assessment_${old_prof_tax_assessment}" class="form-control" id="old_prof_tax_assessment">
                        <div id="old_prof_tax_assessment_error_${old_prof_tax_assessment}" class="error-message text-danger"></div>
                    </div>
                    <div class="col-md-3 mb-3">
