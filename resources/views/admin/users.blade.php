                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="status" id="status" required>
                                ...
                                @foreach(\App\Enums\ActiveStatusEnum::cases() as $status)
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="status" id="team_status" required>
                                ...
                                <option value="{{ $status->value }}"
                                    {{ $status->value === \App\Enums\ActiveStatusEnum::ACTIVE->value ? 'selected' : '' }}>
...
<script>
    $(document).ready(function() {
        ...
        function renderUserCards(users) {
            ...
            users.forEach(user => {
                const profileUrl = user.profile ? `{{ asset('') }}${user.profile}` : '';
                    ...
                    if (response.success) {
                        ...
                        if (user.profile) {
                            $('#updateProfilePreview').html(`
                                <img src="{{ asset('uploads') }}/${user.profile}" class="mt-2" width="100" height="100"
