...
@section('content')
    <div class="container-fluid py-3">
        ...
        <div class="row g-4" id="usersCardsContainer">
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadUsers() {
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        $('#usersCardsContainer').html(`
                    <div class="col-12">
                        <div class="empty-state">
                            <i class="fas fa-exclamation-triangle text-danger"></i>
                            <h4 class="text-danger">Failed to Load Users</h4>
            ...
            function renderUserCards(users) {
                let container = $('#usersCardsContainer');
                container.empty();
                ...
                <div class="col-12">
                    <div class="empty-state">
                        ...
                        <p>Get started by adding your first corporation user.</p>
            ...
            `);
                ...
                users.forEach(user => {
                    ...
                    if (user.profile) {
                        ...
                        profileHtml =
                            `<img src="${profileUrl}" alt="${escapeHtml(user.name)}" class="user-avatar-lg" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline-flex';"><div class="user-avatar-placeholder-lg" style="display:none;"><i class="fas fa-user"></i></div>`;
                    } else {
                        profileHtml =
                            `<div class="user-avatar-placeholder-lg"><i class="fas fa-user"></i></div>`;
                    }
                    ...
                    switch (user.role) {
                        ...
                        case 'team_leader':
                            ...
                            break;
                        case 'surveyor':
                            roleClass = 'role-surveyor';
                            roleText = 'Surveyor';
                            break;
                        case 'dc':
                            roleClass = 'role-dc';
                            roleText = 'District Commissioner';
                            break;
                        case 'commissioner':
                            roleClass = 'role-commissioner';
                        ...
                        <div class="user-card-body">
                            ...
                            <div class="user-info">
                                <div class="user-info-item">
                                    ...
                                    <strong>Email:</strong>
                                    <span title="${escapeHtml(user.email)}">${escapeHtml(user.email).substring(0, 25)}${escapeHtml(user.email).length > 25 ? '...' : ''}</span>
                                </div>
                                <div class="user-info-item">
                                ...
                                <div class="user-info-item">
                                    ...
                                    <span title="${user.corporation ? escapeHtml(user.corporation.name) : '-'}">${user.corporation ? escapeHtml(user.corporation.name).substring(0, 20) : '-'}</span>
                                </div>
                                <div class="user-info-item">
                                ...
                                <div class="user-info-item">
                                    ...
                                    <span>${genderIcon} ${user.gender ? user.gender.charAt(0).toUpperCase() + user.gender.slice(1) : '-'}</span>
                                </div>
                            </div>
                        </div>
            ...
            $(document).on('click', '.edit-user', function() {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    beforeSend: function() {
                        $('#updateSubmitBtn').prop('disabled', true).html(
                    ...
                    complete: function() {
                        $('#updateSubmitBtn').prop('disabled', false).html(
                            '<i class="fas fa-save me-1"></i> Update User');
                    }
                });
            });
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.profile) {
                            const profileUrl = '{{ url('/') }}/' + response.profile;
                            profileHtml =
                                `<img src="${profileUrl}" class="img-fluid rounded-circle mb-3" style="width: 120px; height: 120px; object-fit: cover; border: 3px solid #0dcaf0;">`;
                        } else {
                            profileHtml =
                        ...
                        switch (response.role) {
                            ...
                            case 'surveyor':
                                ...
                                break;
                            case 'dc':
                                roleLabel = 'District Commissioner';
                                break;
                            case 'commissioner':
