                ...
                <div class="layer-content">
                    ...
                    <div class="layer-group">
                        ...
                        <div class="legend-item">
                            <div class="legend-color" style="background: #4CAF50;"></div><span>Residential</span>
                        </div>
                        <div class="legend-item">
                            <div class="legend-color" style="background: #2196F3;"></div><span>Commercial</span>
                        </div>
                        <div class="legend-item">
                            <div class="legend-color" style="background: #FF9800;"></div><span>Industrial</span>
                        </div>
                        <div class="legend-item">
                            <div class="legend-color" style="background: #9C27B0;"></div><span>Mixed Use</span>
                        </div>
                        <div class="legend-item">
                            <div class="legend-color" style="background: #00BCD4;"></div><span>Institutional</span>
                        </div>
                        <div class="legend-item">
                            <div class="legend-color" style="background: #D4A13E;"></div><span>Other</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        window.openImageModal = function(url) {
            if (!$('#imageModal').length) {
                ...
                $(document).on('keydown', e => {
                    if (e.key === 'Escape') $('#imageModal').fadeOut();
                });
            }
        ...
        (function() {
            ...
            function initMap() {
                ...
                // Drone layer
                let droneLayer = new ol.layer.Image({
